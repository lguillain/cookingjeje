 ...
 */
  module.factory(
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/Events/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Event.comments.findById() instead.
            "prototype$__findById__comments": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/Events/:id/comments/:fk",
              method: "GET",
            },

            // INTERNAL. Use Event.comments.destroyById() instead.
            ...
            // INTERNAL. Use Event.comments.updateById() instead.
            ...
            // INTERNAL. Use Event.comments() instead.
            "prototype$__get__comments": {
              isArray: true,
              url: urlBase + "/Events/:id/comments",
              method: "GET",
            },

            // INTERNAL. Use Event.comments.create() instead.
            "prototype$__create__comments": {
              url: urlBase + "/Events/:id/comments",
              method: "POST",
            },

            // INTERNAL. Use Event.comments.destroyAll() instead.
            "prototype$__delete__comments": {
              url: urlBase + "/Events/:id/comments",
              method: "DELETE",
            },

            // INTERNAL. Use Event.comments.count() instead.
            "prototype$__count__comments": {
              url: urlBase + "/Events/:id/comments/count",
              method: "GET",
            },
    ...
    /**
     * @ngdoc object
     * @name lbServices.Event.comments
     * @header lbServices.Event.comments
     * @object
     * @description
     *
     * The object `Event.comments` groups methods
     * manipulating `Comment` instances related to `Event`.
     *
     * Call {@link lbServices.Event#comments Event.comments()}
     ...
     */
        ...
        R.comments = function() {
          ...
          var action = TargetResource["::get::Event::comments"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Event.comments#count
             * @methodOf lbServices.Event.comments
             *
             * @description
             *
        ...
        R.comments.count = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::count::Event::comments"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Event.comments#create
             * @methodOf lbServices.Event.comments
             *
             * @description
             *
        ...
        R.comments.create = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::create::Event::comments"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Event.comments#createMany
             * @methodOf lbServices.Event.comments
             *
             * @description
             *
        ...
        R.comments.createMany = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::createMany::Event::comments"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Event.comments#destroyAll
             * @methodOf lbServices.Event.comments
             *
             * @description
             *
        ...
        R.comments.destroyAll = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::delete::Event::comments"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Event.comments#destroyById
             * @methodOf lbServices.Event.comments
             *
             * @description
             *
        ...
        R.comments.destroyById = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::destroyById::Event::comments"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Event.comments#findById
             * @methodOf lbServices.Event.comments
             *
             * @description
             *
        ...
        R.comments.findById = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::findById::Event::comments"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Event.comments#updateById
             * @methodOf lbServices.Event.comments
             *
             * @description
             *
        ...
        R.comments.updateById = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::updateById::Event::comments"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
     ...
     * manipulating `Client` instances related to `Event`.
     *
 ...
 */
  module.factory(
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/Comments/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Comment.author.create() instead.
            "prototype$__create__author": {
              url: urlBase + "/Comments/:id/author",
              method: "POST",
            },

            // INTERNAL. Use Comment.author.update() instead.
            "prototype$__update__author": {
              url: urlBase + "/Comments/:id/author",
              method: "PUT",
            },

            // INTERNAL. Use Comment.author.destroy() instead.
            ...
            // INTERNAL. Use Event.comments.createMany() instead.
            "::createMany::Event::comments": {
              isArray: true,
              url: urlBase + "/Events/:id/comments",
              method: "POST",
            },
     ...
     * @header lbServices.Comment.author
     * @object
     * @description
     *
     * The object `Comment.author` groups methods
     * manipulating `Client` instances related to `Comment`.
     *
     * Call {@link lbServices.Comment#author Comment.author()}
     * to query all related instances.
     */
        ...
        R.author = function() {
          ...
          return action.apply(R, arguments);
            ...
            /**
             * @ngdoc method
             * @name lbServices.Comment.author#create
             * @methodOf lbServices.Comment.author
             *
             * @description
             *
        ...
        R.author.create = function() {
          var TargetResource = $injector.get("Client");
          var action = TargetResource["::create::Comment::author"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Comment.author#createMany
             * @methodOf lbServices.Comment.author
             *
             * @description
             *
        ...
        R.author.createMany = function() {
          var TargetResource = $injector.get("Client");
          var action = TargetResource["::createMany::Comment::author"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Comment.author#destroy
             * @methodOf lbServices.Comment.author
             *
             * @description
             *
        ...
        R.author.destroy = function() {
          var TargetResource = $injector.get("Client");
          var action = TargetResource["::destroy::Comment::author"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Comment.author#update
             * @methodOf lbServices.Comment.author
             *
             * @description
             *
        ...
        R.author.update = function() {
          var TargetResource = $injector.get("Client");
          var action = TargetResource["::update::Comment::author"];
          return action.apply(R, arguments);
        };
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/Clients/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Comment.author.createMany() instead.
            "::createMany::Comment::author": {
              isArray: true,
              url: urlBase + "/Comments/:id/author",
              method: "POST",
            },
        ...
        R["removeById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Client#patchAttributes
             * @methodOf lbServices.Client
             *
             * @description
             *
